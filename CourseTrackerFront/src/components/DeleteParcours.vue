<template>
<button type="button" :class="classButton" data-bs-toggle="modal" :data-bs-target="'#ParcoursModal-' + parcours!.id" @click="updateParcours"> {{ textButton }} </button>   
<!-- Modal pour supression etape -->
<div class="modal fade" :id="'ParcoursModal-' + parcours!.id" tabindex="-1" aria-labelledby="ParcoursModal" aria-hidden="true">
