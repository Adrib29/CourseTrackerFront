<template>
  <button type="button" :class="classButton" data-bs-toggle="modal" :data-bs-target="'#EtapeModal-' + etape!.id"
    @click="updateEtape"> {{ textButton }} </button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div> Voulez-vous supprimer cette étape ? </div>
        </div>
